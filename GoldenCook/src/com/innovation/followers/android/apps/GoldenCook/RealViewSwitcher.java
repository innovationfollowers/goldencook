...
public class RealViewSwitcher extends ViewGroup {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		//DrawTree.touch_x = (int)ev.getX();
		//DrawTree.touch_y = (int)ev.getY();
		...
		//	DrawTree.isreleased = false;
		//	DrawTree.istouched = true;
			break;
		...
		case MotionEvent.ACTION_UP:
			...
			//DrawTree.istouched =false;
			//DrawTree.isreleased = true;
			//DrawTree.touch_x = -1;
			//DrawTree.touch_y = -1;
	...
	public void DirectsnapToScreen(int whichScreen,int ScreenWidth) {
